...
public class ConfigOption extends BearConfigOption {
    ...
    public static final BearConfigOption PING_PLACEHOLDER = new ConfigOption("ping-placeholder");
    public static final BearConfigOption PING_PLACEHOLDER_PARSED = new ConfigOption("ping-placeholder-parsed");
